...
2. **Customize the generated components** — Edit `_Form.vue` and `List.vue` directly. These are designed to work seamlessly with Crouton's composables and endpoints.
