...
|----------|----------|--------------|
| Generator CLAUDE.md | `packages/nuxt-crouton-collection-generator/CLAUDE.md` | CLI commands, options, field types change |
...
Add to `packages/nuxt-crouton-collection-generator/CLAUDE.md`:
...
## Trigger
When committing changes to `packages/nuxt-crouton-collection-generator/`
...
## Files to Watch
- `packages/nuxt-crouton-collection-generator/lib/**`
- `packages/nuxt-crouton-collection-generator/bin/**`
```
...
on:
  pull_request:
    paths:
      - 'packages/nuxt-crouton-collection-generator/**'
  ...
  validate-sync:
    ...
    steps:
      ...
      - name: Extract field types from generator
        run: |
          node -e "
            import('./packages/nuxt-crouton-collection-generator/lib/utils/helpers.mjs')
...
export { getTypeMapping, FIELD_TYPES } from "@friendlyinternet/nuxt-crouton-collection-generator/lib/utils/helpers.mjs";
...
- [ ] `packages/nuxt-crouton-collection-generator/CLAUDE.md`
  - [ ] Key Files table
