...
// ---------------------------------------------------------------------------
// Runtime appConfig.crouton shape (injected by manifest-injection module)
// ---------------------------------------------------------------------------

/** Module entry as injected into appConfig.crouton.modules at build time */
...
/** Shape of useAppConfig().crouton as injected by the manifest-injection module */
export interface CroutonManifestAppConfig {
  fieldTypes?: Record<string, FieldTypeDefinition>
  autoGeneratedFields?: string[]
  reservedFieldNames?: string[]
  reservedCollectionNames?: string[]
