 ...
 */
function getNuxtConfigOptions(mod) {
 ...
 * @param {string} configPath - Path to nuxt.config.ts
 * @param {string} pattern - String to match against extends entries (substring match)
 * @returns {Promise<{removed: boolean, reason?: string}>}
 */
export async function removeFromNuxtConfigExtends(configPath, pattern) {
  if (!await pathExists(configPath)) {
