...
const handleCreateFlow = () => {
  console.log('[FlowList] Create button clicked, navigating to:', `/admin/${props.teamSlug}/triage/flows/create`)
  console.log('[FlowList] Team slug:', props.teamSlug)
  console.log('[FlowList] Team ID:', props.teamId)
  router.push(`/admin/${props.teamSlug}/triage/flows/create`)
}

// Handle edit flow
const handleEditFlow = (flowId: string) => {
  router.push(`/admin/${props.teamSlug}/triage/flows/${flowId}`)
}
...
const confirmDelete = async () => {
  ...
  try {
    await $fetch(`/api/teams/${props.teamId}/triage-flows/${flowToDelete.value.id}`, {
      method: 'DELETE'
    })
