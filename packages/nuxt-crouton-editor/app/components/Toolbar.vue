<template>
  ...
  >
    ...
    <div class="w-px my-auto h-8 bg-gray-200/70 dark:bg-gray-700/70 mx-1" />
...
const shouldShow = (params: { state: { doc: { nodeAt: (pos: number) => { type: { name: string } } | null }, selection: { empty: boolean } }, from: number }) => {
