...
> **WS1 sign-off artifact** for [#870](https://github.com/FriendlyInternet/nuxt-crouton/issues/870) (epic [#868](https://github.com/FriendlyInternet/nuxt-crouton/issues/868)). This is the *interaction-design* gate (UI sign-off #307): agree on **how the zoom shell navigates** before building it on the real renderers. Build plan + the decisions needing a steer: [`writeups/ui-proposals/ws1-semantic-zoom-shell.md`](../../writeups/ui-proposals/ws1-semantic-zoom-shell.md).
>
> **The keystone it rests on now exists:** WS2 (recursive nested layouts, [#871](https://github.com/FriendlyInternet/nuxt-crouton/issues/871) / PR [#877](https://github.com/FriendlyInternet/nuxt-crouton/pull/877)) shipped the `nested` `LayoutNode`, so the L2 "App is itself a layout" recursion this mock shows is real data, not faked — the shell becomes the *navigation layer* over that recursion.
