<!--
  ...
  - Zod schema: useSalesLocations() composable
...
import type { SalesLocationFormProps, SalesLocationFormData } from '../../types'
import useSalesLocations from '../composables/useSalesLocations'

const props = defineProps<SalesLocationFormProps>()
...
const state = ref<SalesLocationFormData & { id?: string | null }>(initialValues)
