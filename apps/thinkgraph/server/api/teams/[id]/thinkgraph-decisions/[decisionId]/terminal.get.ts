 ...
 *
 * GET /api/teams/:id/thinkgraph-decisions/:decisionId/terminal
 *
...
export default defineEventHandler(async (event) => {
  ...
  const session = getTerminalSession(decisionId)
  ...
  const unsubscribe = subscribeTerminal(decisionId, (evt) => {
    send(evt)
