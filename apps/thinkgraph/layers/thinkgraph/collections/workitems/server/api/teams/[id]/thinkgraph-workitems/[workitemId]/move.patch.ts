...
import { updatePositionThinkgraphWorkItem } from '../../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  const result = await updatePositionThinkgraphWorkItem(team.id, workItemId, parentId, body.order)
  dbTimer.end()
  return result
})