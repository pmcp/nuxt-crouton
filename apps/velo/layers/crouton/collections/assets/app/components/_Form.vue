<!--
  ...
  - Zod schema: useCroutonAssets() composable
...
import type { CroutonAssetFormProps, CroutonAssetFormData } from '../../types'
import useCroutonAssets from '../composables/useCroutonAssets'

const props = defineProps<CroutonAssetFormProps>()
const { defaultValue, schema, collection } = useCroutonAssets()
