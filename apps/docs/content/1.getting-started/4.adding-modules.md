...
**Auto-included packages:** When you install `@friendlyinternet/nuxt-crouton`, the **auth**, **admin**, and **i18n** packages are automatically included. You don't need to install them separately.
::
...
These packages are automatically included when you install `@friendlyinternet/nuxt-crouton`:
...
The auth module is automatically included with `@friendlyinternet/nuxt-crouton`. No separate installation needed.
...
The i18n module is automatically included with `@friendlyinternet/nuxt-crouton`. No separate installation needed.
...
**Cause:** The core package `@friendlyinternet/nuxt-crouton` isn't installed.
