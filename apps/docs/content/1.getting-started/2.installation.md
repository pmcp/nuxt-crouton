...
export default defineNuxtConfig({
  extends: [
    '@fyit/crouton',
    // '@fyit/crouton-editor',   // If using rich text editor
  ],
...
::callout{icon="i-heroicons-cube" color="blue"}
**Auto-included:** The core package automatically includes `@nuxthub/core` (database, KV, blob storage), `nuxt-crouton-auth` (authentication), `nuxt-crouton-admin` (super admin), and `nuxt-crouton-i18n` (translations). No separate installation needed.
::
