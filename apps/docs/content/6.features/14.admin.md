...
The `@friendlyinternet/nuxt-crouton-admin` package provides a complete admin dashboard for managing users, teams, and platform moderation. It extends `@friendlyinternet/nuxt-crouton-auth` and provides pre-built pages, components, and composables for admin functionality.
