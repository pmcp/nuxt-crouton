...
The `@friendlyinternet/nuxt-crouton-editor` package provides a powerful, accessible rich text editing experience powered by **[TipTap](https://tiptap.dev)**, seamlessly integrated with Nuxt Crouton's form system. Perfect for blog posts, content management, and any text-heavy forms.
