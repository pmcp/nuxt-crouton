...
The `@fyit/crouton-editor` package provides a powerful, accessible rich text editing experience powered by **[Nuxt UI Editor](https://ui.nuxt.com/docs/components/editor)** (TipTap-based), seamlessly integrated with Nuxt Crouton's form system. Perfect for blog posts, content management, and any text-heavy forms.
...
**Nuxt UI included**: `@nuxt/ui` is automatically included by `@fyit/crouton-core`, no separate installation needed.
::
...
- **Package**: https://www.npmjs.com/package/@fyit/crouton-editor
