...
**Status: Beta** - This package (v0.1.0) is experimental and under active development. The API may change between versions.
::
...
- **@nuxt/devtools:** v3.0.0 or higher (installed automatically)
- **@fyit/crouton:** Any version
...
::callout{icon="i-lucide-info" color="blue"}
**Internal Only**: The following components are internal to the DevTools iframe UI. They are not importable or usable in your application — they power the DevTools panel interface only.
::
...
2. **Verify the Nitro plugin is loaded:**
   - Check that the operationTracker plugin is registered
...
- **Plugin execution:** <1ms per request
...
::callout{icon="i-lucide-info" color="blue"}
**Want to influence the roadmap?** Provide feedback via [GitHub Issues](https://github.com/pmcp/nuxt-crouton/issues) or [Discussions](https://github.com/pmcp/nuxt-crouton/discussions).
::
...
See [CONTRIBUTING.md](https://github.com/pmcp/nuxt-crouton/blob/main/CONTRIBUTING.md) for full guidelines.
...
- **[@fyit/crouton](https://www.npmjs.com/package/@fyit/crouton)** - Core library
...
5. **[Provide feedback](https://github.com/pmcp/nuxt-crouton/issues)** to shape future development

::callout{icon="i-lucide-rocket" color="blue"}
