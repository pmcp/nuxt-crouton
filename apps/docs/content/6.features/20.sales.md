...
Utility function that calculates an item's price including option price modifiers. It is auto-imported as a composable when the `@fyit/crouton-sales` layer is extended -- no import statement is needed:
