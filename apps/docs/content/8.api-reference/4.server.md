...
### Integration with Collection Proxy Utilities

Client-side proxy utilities automatically integrate with external collection handlers:
...
```typescript
{
  ...
  membership: TeamMember  // The member record proving user is in team
}
```
