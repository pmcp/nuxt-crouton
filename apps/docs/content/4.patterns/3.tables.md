...
Tables include default columns: `createdAt`, `updatedAt`, `updatedBy`, `select`, `presence`, and `actions`. Hide them selectively:
...
::callout{type="info" icon="i-lucide-sparkles"}
