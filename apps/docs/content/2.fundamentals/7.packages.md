...
Nuxt Crouton is a **modular ecosystem** consisting of 13 packages (1 core, 1 generator CLI, 1 auth layer, and 10 addon layers). This architecture provides flexibility, keeps bundle sizes small, and allows you to use only what you need.
