...
**i18n Locale Files**: This package includes app-level translation strings (en, nl, fr) that merge with your layer translations.
...
- [Export](/features/export) - Data export functionality
