...
Nuxt Crouton is a **modular ecosystem** consisting of 13 packages (1 core, 1 generator CLI, 1 auth layer, 1 themes package, and 9 addon layers). This architecture provides flexibility, keeps bundle sizes small, and allows you to use only what you need.
...
### 11. @fyit/crouton-auth (Auto-Included)
...
### 12. @fyit/crouton-admin (Auto-Included)
...
**Q: Why are i18n and editor separate addon layers?**
A: Not every app needs translations or rich text editing. By making them optional, we keep the core package lean.
...
A: No. Each addon only depends on the core. You can use i18n without editor and vice versa.
