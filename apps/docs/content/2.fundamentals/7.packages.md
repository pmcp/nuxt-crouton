...
### 12. @friendlyinternet/crouton-auth

**Purpose**: Authentication layer with teams, billing, passkeys, and 2FA
**Install**: `pnpm add @friendlyinternet/crouton-auth`
...
**Required for**: `@friendlyinternet/crouton-admin` (admin dashboard)

---

### 13. @friendlyinternet/crouton-admin

**Purpose**: Super admin dashboard for user management and moderation
**Install**: `pnpm add @friendlyinternet/crouton-admin`
...
┌─────────────────────────────────────┐
│  @friendlyinternet/crouton-auth     │ ← Auth Layer (standalone)
│  - Better Auth, teams, billing      │
└─────────────────────────────────────┘
              ↑
              │ extends
┌─────────────────────────────────────┐
│  @friendlyinternet/crouton-admin    │ ← Admin Dashboard
...
pnpm list @friendlyinternet/crouton-auth
pnpm list @friendlyinternet/crouton-admin
