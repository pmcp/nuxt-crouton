...
```bash
npx crouton-generate rollback shop products --keep-files
```
...
```bash
npx crouton-generate rollback shop products --force
```
...
```bash
npx crouton-generate rollback-bulk --config=./crouton.config.js
...
npx crouton-generate rollback-bulk --layer=shop --dry-run

# Keep files, clean config
npx crouton-generate rollback-bulk --layer=shop --keep-files

# Skip confirmation
npx crouton-generate rollback-bulk --layer=shop --force
```
...
```bash
# Preview mode
npx crouton-generate rollback-interactive --dry-run

# Keep files
npx crouton-generate rollback-interactive --keep-files
```
...
```bash
# Remove unused layer
npx crouton-generate rollback-bulk --layer=experiments --force
```
