...
import { getAllDiscubotFlows, getDiscubotFlowsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getDiscubotFlowsByIds(team.id, ids)
  }

  return await getAllDiscubotFlows(team.id)
})