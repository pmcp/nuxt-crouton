...
import { getAllRakimConfigs, getRakimConfigsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getRakimConfigsByIds(team.id, ids)
  }

  return await getAllRakimConfigs(team.id)
})