...
import { getAllDiscubotConfigs, getDiscubotConfigsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getDiscubotConfigsByIds(team.id, ids)
  }

  return await getAllDiscubotConfigs(team.id)
})