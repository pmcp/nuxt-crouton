...
export const rakimDiscussionSchema = z.object({
...
export const rakimDiscussionsColumns = [
...
export const rakimDiscussionsConfig = {
  name: 'rakimDiscussions',
  layer: 'rakim',
  apiPath: 'rakim-discussions',
  componentName: 'RakimDiscussionsForm',
  schema: rakimDiscussionSchema,
  defaultValues: {
    sourceType: '',
    sourceThreadId: '',
    sourceUrl: '',
  ...
  columns: rakimDiscussionsColumns,
}

export const useRakimDiscussions = () => rakimDiscussionsConfig

// Default export for auto-import compatibility
export default function () {
  return {
    defaultValue: rakimDiscussionsConfig.defaultValues,
    schema: rakimDiscussionsConfig.schema,
    columns: rakimDiscussionsConfig.columns,
    collection: rakimDiscussionsConfig.name
  }
}