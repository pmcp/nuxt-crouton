...
import { getAllDiscubotDiscussions, getDiscubotDiscussionsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getDiscubotDiscussionsByIds(team.id, ids)
  }

  return await getAllDiscubotDiscussions(team.id)
})