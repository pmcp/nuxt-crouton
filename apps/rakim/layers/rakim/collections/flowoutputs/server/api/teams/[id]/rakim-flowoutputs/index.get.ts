...
import { getAllRakimFlowOutputs, getRakimFlowOutputsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getRakimFlowOutputsByIds(team.id, ids)
  }

  return await getAllRakimFlowOutputs(team.id)
})