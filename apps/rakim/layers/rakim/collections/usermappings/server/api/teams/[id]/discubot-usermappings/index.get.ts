...
import { getAllDiscubotUserMappings, getDiscubotUserMappingsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getDiscubotUserMappingsByIds(team.id, ids)
  }

  return await getAllDiscubotUserMappings(team.id)
})