...
import { getAllDiscubotInboxMessages, getDiscubotInboxMessagesByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getDiscubotInboxMessagesByIds(team.id, ids)
  }

  return await getAllDiscubotInboxMessages(team.id)
})