...
import { getAllDiscubotTasks, getDiscubotTasksByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getDiscubotTasksByIds(team.id, ids)
  }

  return await getAllDiscubotTasks(team.id)
})