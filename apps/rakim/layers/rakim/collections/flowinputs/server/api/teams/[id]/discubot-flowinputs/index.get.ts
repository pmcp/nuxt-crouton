...
import { getAllDiscubotFlowInputs, getDiscubotFlowInputsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getDiscubotFlowInputsByIds(team.id, ids)
  }

  return await getAllDiscubotFlowInputs(team.id)
})