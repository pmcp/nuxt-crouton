...
import { getAllRakimFlowInputs, getRakimFlowInputsByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getRakimFlowInputsByIds(team.id, ids)
  }

  return await getAllRakimFlowInputs(team.id)
})