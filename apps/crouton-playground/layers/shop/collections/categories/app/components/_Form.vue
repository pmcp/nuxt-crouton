<!--
  ...
  - Zod schema: useShopCategories() composable
...
import type { ShopCategorieFormProps, ShopCategorieFormData } from '../../types'
import useShopCategories from '../composables/useShopCategories'

const props = defineProps<ShopCategorieFormProps>()
const { defaultValue, schema, collection } = useShopCategories()
...
const state = ref<ShopCategorieFormData & { id?: string | null }>(initialValues)
