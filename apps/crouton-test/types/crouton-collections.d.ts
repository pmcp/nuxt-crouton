...
import type { BookingsAsset, BookingsAssetFormData, NewBookingsAsset } from './layers/bookings/collections/assets/types'
...
declare module '#crouton/types' {
  interface CollectionTypeMap {
    bookingsAssets: {
      Item: BookingsAsset
      FormData: BookingsAssetFormData
      NewItem: NewBookingsAsset
    }
    bookingsBookings: {
