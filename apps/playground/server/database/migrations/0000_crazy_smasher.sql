...
CREATE TABLE `playground_decisions` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
	`parentId` text,
...
--> statement-breakpoint
CREATE TABLE `playground_options` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
	`order` integer NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `playground_posts_slug_unique` ON `playground_posts` (`slug`);--> statement-breakpoint
