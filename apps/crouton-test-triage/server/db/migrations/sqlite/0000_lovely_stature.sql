...
CREATE TABLE `triage_discussions` (
	`id` text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE `triage_flowinputs` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
	`order` integer NOT NULL,
...
--> statement-breakpoint
CREATE TABLE `triage_flowoutputs` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
	`order` integer NOT NULL,
...
--> statement-breakpoint
CREATE TABLE `triage_inboxmessages` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
	`order` integer NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `triage_tasks_notionPageId_unique` ON `triage_tasks` (`notionPageId`);--> statement-breakpoint
CREATE TABLE `triage_usermappings` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
	`order` integer NOT NULL,
