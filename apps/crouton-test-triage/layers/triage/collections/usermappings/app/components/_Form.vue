<!--
  ...
  ## AI Context
  - Form component for usermappings collection
  - Handles: create, update, delete actions
  - API endpoint: /api/teams/[id]/triage-usermappings
  - Zod schema: useTriageUserMappings() composable
...
import type { TriageUserMappingFormProps, TriageUserMappingFormData } from '../../types'
import useTriageUserMappings from '../composables/useTriageUserMappings'

const props = defineProps<TriageUserMappingFormProps>()
const { defaultValue, schema, collection } = useTriageUserMappings()
...
const state = ref<TriageUserMappingFormData & { id?: string | null }>(initialValues)
