<!--
  ...
  ## AI Context
  - Form component for inboxmessages collection
  - Handles: create, update, delete actions
  - API endpoint: /api/teams/[id]/triage-inboxmessages
  - Zod schema: useTriageInboxMessages() composable
...
import type { TriageInboxMessageFormProps, TriageInboxMessageFormData } from '../../types'
import useTriageInboxMessages from '../composables/useTriageInboxMessages'

const props = defineProps<TriageInboxMessageFormProps>()
const { defaultValue, schema, collection } = useTriageInboxMessages()
...
const state = ref<TriageInboxMessageFormData & { id?: string | null }>(initialValues)
