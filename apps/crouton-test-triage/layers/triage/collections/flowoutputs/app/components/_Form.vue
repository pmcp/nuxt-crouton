<!--
  ...
  ## AI Context
  - Form component for flowoutputs collection
  - Handles: create, update, delete actions
  - API endpoint: /api/teams/[id]/triage-flowoutputs
  - Zod schema: useTriageFlowOutputs() composable
...
import type { TriageFlowOutputFormProps, TriageFlowOutputFormData } from '../../types'
import useTriageFlowOutputs from '../composables/useTriageFlowOutputs'

const props = defineProps<TriageFlowOutputFormProps>()
const { defaultValue, schema, collection } = useTriageFlowOutputs()
...
const state = ref<TriageFlowOutputFormData & { id?: string | null }>(initialValues)
