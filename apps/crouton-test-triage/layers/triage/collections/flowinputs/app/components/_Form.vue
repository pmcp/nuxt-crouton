<!--
  ...
  ## AI Context
  - Form component for flowinputs collection
  - Handles: create, update, delete actions
  - API endpoint: /api/teams/[id]/triage-flowinputs
  - Zod schema: useTriageFlowInputs() composable
...
import type { TriageFlowInputFormProps, TriageFlowInputFormData } from '../../types'
import useTriageFlowInputs from '../composables/useTriageFlowInputs'

const props = defineProps<TriageFlowInputFormProps>()
const { defaultValue, schema, collection } = useTriageFlowInputs()
...
const state = ref<TriageFlowInputFormData & { id?: string | null }>(initialValues)
