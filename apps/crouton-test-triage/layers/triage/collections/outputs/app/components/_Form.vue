...
import type { TriageOutputFormProps, TriageOutputFormData } from '../../types'
import useTriageOutputs from '../composables/useTriageOutputs'

const props = defineProps<TriageOutputFormProps>()
const { defaultValue, schema, collection } = useTriageOutputs()
