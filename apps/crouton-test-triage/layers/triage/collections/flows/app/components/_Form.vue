...
import type { TriageFlowFormProps, TriageFlowFormData } from '../../types'
import useTriageFlows from '../composables/useTriageFlows'

const props = defineProps<TriageFlowFormProps>()
const { defaultValue, schema, collection } = useTriageFlows()
...
const state = ref<TriageFlowFormData & { id?: string | null }>(initialValues)
