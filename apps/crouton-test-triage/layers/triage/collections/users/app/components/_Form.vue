...
import type { TriageUserFormProps, TriageUserFormData } from '../../types'
import useTriageUsers from '../composables/useTriageUsers'

const props = defineProps<TriageUserFormProps>()
const { defaultValue, schema, collection } = useTriageUsers()
...
const state = ref<TriageUserFormData & { id?: string | null }>(initialValues)
