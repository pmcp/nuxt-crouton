<!--
  ...
  - Zod schema: useTriageTasks() composable
...
import type { TriageTaskFormProps, TriageTaskFormData } from '../../types'
import useTriageTasks from '../composables/useTriageTasks'

const props = defineProps<TriageTaskFormProps>()
const { defaultValue, schema, collection } = useTriageTasks()
...
const state = ref<TriageTaskFormData & { id?: string | null }>(initialValues)
