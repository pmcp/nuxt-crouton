...
import type { TriageInputFormProps, TriageInputFormData } from '../../types'
import useTriageInputs from '../composables/useTriageInputs'

const props = defineProps<TriageInputFormProps>()
const { defaultValue, schema, collection } = useTriageInputs()
