 ...
 * - categorizeCategorizeLayouts: CategorizeCategorizeLayout
...
import type { CategorizeCategorizeLayout, CategorizeCategorizeLayoutFormData, NewCategorizeCategorizeLayout } from './layers/categorize/collections/categorize-layouts/types'
...
declare module '#crouton/types' {
  interface CollectionTypeMap {
    categorizeCategorizeLayouts: {
      Item: CategorizeCategorizeLayout
      FormData: CategorizeCategorizeLayoutFormData
      NewItem: NewCategorizeCategorizeLayout
    }
    pagesPages: {
      Item: PagesPage
