...
/**
 * Team Section Parent Layout (ThinkGraph override)
 *
 * Extends crouton-admin's team.vue with an additional Notion tab.
...
// Tab navigation items — includes Notion tab for ThinkGraph
const tabs = computed(() => [
  [
    {
    ...
    },
    {
      ...
      to: `/admin/${teamSlug.value}/team/notion`
    }
  ]
])
</script>
