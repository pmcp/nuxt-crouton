...
--> statement-breakpoint
CREATE TABLE `kvr_werkvergunningens` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
	`order` integer NOT NULL,
	`sblNumber` text NOT NULL,
	...
	`plaats` text,
	`opgemaaktOp` integer,
	`werkverantwoordelijkeNaam` text,
	`werkverantwoordelijkeVoornaam` text,
	`werkverantwoordelijkeHoedanigheid` text,
	`werkverantwoordelijkeAannemer` text,
	`werkverantwoordelijkeHandtekening` text,
	`schakelbevoegdeNaam` text,
	`schakelbevoegdeVoornaam` text,
	`schakelbevoegdeHandtekening` text,
	`photos` text,
	`recipientEmail` text NOT NULL,
	`emailStatus` text,
	`createdAt` integer NOT NULL,
