#!/usr/bin/env node
/**
 * sync-wrangler-ids.mjs — the missing piece for #114 (apps/crouton-builder-demo reference).
 *
 ...
 *   1. queries `wrangler d1 list --json` + `wrangler kv namespace list --json`,
 ...
 *          `<workerName>-<binding>`            e.g. crouton-builder-demo-preview-KV  (the rule)
 *          `<workerName>-<binding lowercased>` e.g. crouton-builder-demo-preview-kv  (safety net)
 ...
 *   the `wrangler` shell-outs. Each is the raw JSON `wrangler … --json` would print.
 */
