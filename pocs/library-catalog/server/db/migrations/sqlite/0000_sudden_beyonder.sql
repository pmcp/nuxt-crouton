...
CREATE TABLE `library_catalog_authors` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
	`name` text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `library_catalog_books_team_isbn_idx` ON `library_catalog_books` (`teamId`,`isbn`);--> statement-breakpoint
CREATE TABLE `library_catalog_genres` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
	`name` text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `library_catalog_genres_team_name_idx` ON `library_catalog_genres` (`teamId`,`name`);--> statement-breakpoint
CREATE TABLE `library_catalog_loans` (
	`id` text PRIMARY KEY NOT NULL,
	`teamId` text NOT NULL,
	`owner` text NOT NULL,
